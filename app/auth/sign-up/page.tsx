...
export default function SignUpPage() {
  ...
  return (
    <AuthLayoutWrapper 
      ...
      subtitle="Start monitoring websites with Kin in seconds."
    >
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          <label className="block text-[12.5px] font-semibold text-[#5A5D6B] mb-[6px]">
            Password
          </label>
          <input
            type="password"
          ...
          />
          <span className="text-[11.5px] text-[#8A8D9A] mt-1 block">At least 6 characters</span>
        </div>
